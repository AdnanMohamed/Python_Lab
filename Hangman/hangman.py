...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    while(guesses >= 0 and not win):
        ...
        if letter in get_available_letters(letters_guessed) and letter in secret_word:
            letters_guessed.append(letter)
            print("Good guess:",get_guessed_word(secret_word, letters_guessed))
            if is_word_guessed(secret_word, letters_guessed):
                win = True
        
        elif letter in get_available_letters(letters_guessed) and letter not in secret_word:
        ...
        elif(letter not in get_available_letters(letters_guessed) and warnings != 0):
            warnings -= 1
    ...
    if win:
        points = guesses * len(set(secret_word))
        print("Congratulations, you won!")
        print("Your total score for this game is:",points)
    else:
...
def hangman_with_hints(secret_word):
    ...
    * If the guess is the symbol *, print out all words in wordlist that
    ...
    while(guesses >= 0 and not win):
        ...
        elif letter in get_available_letters(letters_guessed) and letter not in secret_word and letter != '*':
            print("Oops! That letter is not in my word:",get_guessed_word(secret_word, letters_guessed))
            letters_guessed.append(letter)
            if letter in "aeiou":
                guesses -= 2
        ...
        elif(letter not in get_available_letters(letters_guessed) and warnings != 0 and letter != '*'):
            warnings -= 1
            print(f"Oops! That is not a valid letter. You now have {warnings} warnings:")
